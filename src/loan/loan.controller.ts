...
export class LoanController {
  ...
  addComment(
    ...
    return this.loanService.addCommentNew(publicId, addCommentDto, user, file);
  }
  ...
  updateLoanStatus(
    ...
    return this.loanService.updateLoanStatusNew(publicId, updateLoanStatusDto, user);
  }
  ...
  async getAvailableLegalStatuses(@Param('publicId') publicId: ParseUUIDPipe, @GetUser() user: User) {
    return this.loanService.getAvailableLegalStatuses(publicId, user);
  }
