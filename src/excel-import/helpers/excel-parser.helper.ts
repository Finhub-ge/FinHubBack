...
export class ExcelParserHelper {
  ...
  private buildAttributesColumnMap(headerRow: ExcelJS.Row): Record<string, number> {
    ...
    const fieldMapping: Record<string, string> = {
      ...
      'Delay Date': 'Delay Date',
      'initPrincipal': 'initPrincipal',
      'Case Penalty': 'Case Penalty',
      'Left Interest Fee': 'Left Interest Fee',
      'Other Fees': 'Other Fees',
      'Original Principal': 'Original Principal',
      'Case Issue Date': 'Case Issue Date',
      'Case Return Date': 'Case Return Date',
      'Last Payment Date': 'Last Payment Date',
      'Last Payment Amount': 'Last Payment Amount',
      'Legal Identifier': 'Legal Identifier',
      'Legal Stage Comment': 'Legal Stage Comment',
      'Currency': 'Currency',
      ...
      'VIN Code': 'VIN Code',
      'Car state number': 'Car state number',
      'Comp Legal Form': 'Comp Legal Form',
      'Comp ID Number': 'Comp ID Number',
      'Term of validity of the contract (months)': 'Term of validity of the contract (months)',
      'Georgian Citizen (YES/NO)': 'Georgian Citizen (YES/NO)',
      'PartiallySecuredByDeposit': 'partiallySecuredByDeposit',
      'ContractStatus': 'ContractStatus',
      'RepaymentType': 'RepaymentType',
      'InstallmentType': 'InstallmentType',
      ...
      'საკონტაქტო პირის მობილურის ნომერი': 'საკონტაქტო პირის მობილურის ნომერი',
    };
